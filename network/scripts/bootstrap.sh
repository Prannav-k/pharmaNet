...
COUNTER=1
MAX_RETRY=15
ORGS="manufacturer distributor"  #UPDATE REQUIRED
...
joinChannel() {
  ...
  joinChannelWithRetry 2 distributor   #UPDATE REQUIRED
}
...
echo
echo "========= All GOOD, Hyperledger Fabric Property pharma Network Is Now Up and Running! =========== "
echo
