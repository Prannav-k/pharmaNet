...
async function main(org, fabricUserName, channelName, chainCodeName, smartContractName,buyerCRN, sellerCRN, drugName, quantity) {
	...
	try {
		...
		dataBuffer = await txObject.submit( buyerCRN, sellerCRN, drugName, quantity);
