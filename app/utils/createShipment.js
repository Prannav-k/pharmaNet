...
async function main(org, fabricUserName, channelName, chainCodeName, smartContractName,buyerCRN, drugName, listOfAssets, transporterCRN) {
	...
	try {
		...
		let txObject = await objContract.createTransaction('createShipmemt')
		let txId = txObject.getTransactionID()
		dataBuffer = await txObject.submit( buyerCRN, drugName, listOfAssets, transporterCRN);
